...
const Header = (props) => {
    return (
        <div>
            <nav className="navbar navbar-expand-lg navbar-dark bg-dark container rounded mt-1">
                <div className="container-fluid">
                    <a className="navbar-brand text-danger fw-bold fs-3" href="/home">MealsDB</a>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item">
                                <a className="nav-link active" href="/Meals">Meals</a>
                            </li>
                            <li className="nav-item">
